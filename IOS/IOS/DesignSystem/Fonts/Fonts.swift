...
extension Font {
    ...
    static let bold_20: Font = Font.custom("Poppins", size: 20)
        .weight(.bold)
    static let bold_16: Font = Font.custom("Poppins", size: 16)
        .weight(.bold)
    static let bold_14: Font = Font.custom("Poppins", size: 14)
        .weight(.bold)
    
    static let semibold_16: Font = Font.custom("Poppins", size: 16)
        .weight(.semibold)
}
